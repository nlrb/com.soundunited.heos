	        ...
	        if( friendlyName ) {
		        friendlyName = friendlyName.replace('ACT-', '');
					...
					this.emit('device', {
						...
						manufacturer     : matchBetweenTags('manufacturer', body),
						modelName        : matchBetweenTags('modelName', body),
						modelNumber      : matchBetweenTags('modelNumber', body),
						serialNumber     : matchBetweenTags('serialNumber', body),
						firmwareVersion  : matchBetweenTags('firmware_version', body),
						firmwareDate     : matchBetweenTags('firmware_date', body),
						firmwareRevision : matchBetweenTags('firmwareRevision', body),
						// productRevision
						// moduleType
						// moduleRevision
						// releaseType
